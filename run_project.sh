...
ansible-playbook -vvv -e profile_aws="643019619955_Users" -e region="eu-west-2" -e cidr_eks_vpc="10.42.0.0/16" -e owner="h.kleinbourg" -e mail="h.kleinbourg@f5.com" ./Ansible_Playbooks/Infra_AWS.yml --tags create
